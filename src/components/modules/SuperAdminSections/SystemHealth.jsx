...
import {
  ...
  HelpCircle, Clock, Activity, Filter, ChevronDown,
  Radio,
} from 'lucide-react';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ background: overall.color + '12', border: `1px solid ${overall.color}30`, borderRadius: 12, padding: '12px 18px', display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: '0.7rem', color: 'var(--sa2-text-muted)' }}>
            {upCount} opérationnels · {degradedCount} dégradés · {downCount} hors ligne
          </div>
        </div>
      </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div style={{ position: 'relative' }}>
              <select
                ...
                style={{ padding: '4px 24px 4px 8px', borderRadius: 6, border: '1px solid var(--sa2-border)', background: 'var(--sa2-surface2)', color: 'var(--sa2-text)', fontSize: '0.75rem', cursor: 'pointer', appearance: 'none', paddingRight: 20 }}
              >
            ...
            <div style={{ position: 'relative' }}>
              ...
              >
                ...
                {['system','auth','api','ttlock','rfid','stripe','automation'].map(m =>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.78rem' }}>
              ...
              <tbody>
                {logs.map((log, i) => {
                  ...
                  return (
                    <tr key={log.id || i} style={{ borderBottom: '1px solid var(--sa2-border)', transition: 'background 0.1s' }}>
                      ...
                      <td style={{ padding: '7px 12px', color: 'var(--sa2-text-muted)', whiteSpace: 'nowrap', fontSize: '0.72rem' }}>
                        {log.module}
                      </td>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 14px', background: '#3B82F610', border: '1px solid #3B82F630', borderRadius: 10, fontSize: '0.75rem', color: '#93C5FD' }}>
        <Radio size={12} />
        Les modules PMS (réservations, clients, chambres, accès) reçoivent les mises à jour en temps réel via Supabase Realtime — aucun rechargement de page nécessaire.
      </div>
    </div>
  );
}
